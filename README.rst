...
be something like::
    ...
    wheel-uploader -v -w ~/wheelhouse -t macosx Cython 0.23
    wheel-uploader -v -w ~/wheelhouse -t manylinux1 Cython 0.23
    wheel-uploader -v -w ~/wheelhouse -t win Cython 0.23
