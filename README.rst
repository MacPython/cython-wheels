...
be something like::
    ...
    wheel-uploader -r warehouse -u $CDN_URL -v -w ~/wheelhouse -t macosx Cython 0.23
    wheel-uploader -r warehouse -u $CDN_URL -v -w ~/wheelhouse -t manylinux1 Cython 0.23
    wheel-uploader -r warehouse -u $CDN_URL -v -w ~/wheelhouse -t win Cython 0.23
